...
public class GameMenuController4 : MonoBehaviour
{
    ...
    {
        OpenGameMenu();
        useJoystickToggle.isOn = playerController.useJoystickControl;
        useJoystickToggle.onValueChanged.AddListener(OnUseJoystickToggleValueChanged);
    }
    ...
    private void OnUseJoystickToggleValueChanged(bool isOn)
    {
        playerController.useJoystickControl = isOn;
    }
